...
{
    public class RedAffiliation : Affiliation
    {

        private BuildingFactory _buildingFactory = new BuildingFactory();
        private Home _home;
        
        public RedAffiliation()
        {
            affiliation = AffiliationEnum.RED;
        }
        ...
        public override void initialize()
        {
            ...
            _home = _buildingFactory.createHome(affiliation, new Vector3((float)150,17,0),buildingAttribute);
        }
